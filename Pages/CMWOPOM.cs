        ...
        AllureLogger.LogStep("I verify COMP-WREV Status", () =>
        {
              try
              {
                       // Wait 5 seconds for the page or element to load
                        ...
                        // Find the Related Work Order element by CSS selector
                        var WorkOrderStatus = driver.FindElement(By.CssSelector("#me6e07274-tb"));
      ...
      AllureLogger.LogStep("Capture Screenshot for GTRDWM-REG-203SC02", () =>
      {
        ...
        AllureLogger.LogStep("Work log Status field has value UPDATE", () =>
        {
            try
            {
                ...
                // Find the Related Work Order element by CSS selector
                var WorkOrderStatus = driver.FindElement(By.CssSelector("#m3fe6df06-tb"));
                ...
                if (string.IsNullOrEmpty(Status))
                {
                    throw new Exception("Status: Work log Status field is empty or null.");
                }
            ...
            {
                Console.WriteLine("Error: Work log Status field element not found - " + ex.Message);
                throw;
            }
            catch (Exception ex)
            {
      ...
      AllureLogger.LogStep("I press ok dialog button", () =>
       ...
       AllureLogger.LogStep("I verify COMP-WREV Status", () =>
       {
           try
           {
               ...
               // Find the Related Work Order element by CSS selector
               var WorkOrderStatus = driver.FindElement(By.CssSelector("#md70d61ba-tb"));
                ...
                try
                {
                       // Wait 5 seconds for the page or element to load
                         Task.Delay(10000).Wait();
                          ...
                          // Find the Related Work Order element by CSS selector
                          var WorkOrderStatus = driver.FindElement(By.CssSelector("#md3801d08-tb"));
                     ...
                     if (string.IsNullOrEmpty(Status))
                     {
                           throw new Exception("work order Status: Work order number is empty or null.");
                     }
