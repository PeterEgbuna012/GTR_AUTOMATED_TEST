...
Scenario: 01) Creation of a Qualification
	  ...
	  And I select no. 1 record from Qualification Type table records
	  ...
	  And I enter Craft and Skill Level:
		  | Craft | Skill-Level |
 ...
 Scenario: 02) Delete Qualification
	  ...
	  And I select delete Craft Skill-Level
	  And I save record
	  And I select delete Qualifications
	  And I press Yes dialog button
	  And I refresh table records
