...
namespace GTR_AUTOMATED.Features.MaintenaceProduction.EM
{
    ...
    [NUnit.Framework.DescriptionAttribute("0.0.6 - Rejecting an EM Work Order")]
    ...
    public partial class _0_0_6_RejectingAnEMWorkOrderFeature
    {
        ...
        private static global::Reqnroll.FeatureInfo featureInfo = new global::Reqnroll.FeatureInfo(new global::System.Globalization.CultureInfo("en-US"), "Features/Maintenace & Production/EM", "0.0.6 - Rejecting an EM Work Order", "You are reviewing Completed Work in your start centre and want to reject it to be" +
                " reviewed by the person who completed the work", global::Reqnroll.ProgrammingLanguage.CSharp, featureTags);
...
#line hidden
        ...
        [NUnit.Framework.CategoryAttribute("Feature:0.0.6-RejectinganEMWorkOrder")]
...
#line hidden
                ...
                table163.AddRow(new string[] {
                            "HORNSEY"});
#line 12
    await testRunner.AndAsync("I filter table Location:", ((string)(null)), table163, "And ");
#line hidden
#line 15
...
#line hidden
                ...
                table165.AddRow(new string[] {
                            "TAUTO"});
#line 29
    await testRunner.AndAsync("I enter following data to Headcode:", ((string)(null)), table165, "And ");
#line hidden
...
#line 32
    await testRunner.AndAsync("I enter following data:", ((string)(null)), table166, "And ");
#line hidden
#line 35
...
#line hidden
                ...
                table167.AddRow(new string[] {
                            ...
                            "=EM"});
#line 57
     await testRunner.WhenAsync("I filter table EM:", ((string)(null)), table167, "When ");
#line hidden
#line 60
...
#line hidden
                ...
                table168.AddRow(new string[] {
                            ...
                            "=EM"});
#line 78
      await testRunner.WhenAsync("I filter table EM:", ((string)(null)), table168, "When ");
#line hidden
#line 81
     await testRunner.AndAsync("I select no. 1 record from EM table", ((string)(null)), ((global::Reqnroll.Table)(null)), "And ");
#line hidden
...
#line hidden
                ...
                table169.AddRow(new string[] {
                            "ABRACE"});
#line 85
     await testRunner.AndAsync("I filter table labor:", ((string)(null)), table169, "And ");
#line hidden
#line 88
...
#line hidden
                ...
                table170.AddRow(new string[] {
                            ...
                            "=EM"});
#line 104
    await testRunner.WhenAsync("I filter table Quick Work Order:", ((string)(null)), table170, "When ");
#line hidden
#line 107
    await testRunner.AndAsync("I select no. 1 record from EM table", ((string)(null)), ((global::Reqnroll.Table)(null)), "And ");
#line hidden
...
#line hidden
                ...
                table171.AddRow(new string[] {
                            "ABRACE"});
#line 118
     await testRunner.AndAsync("I filter table Record labor:", ((string)(null)), table171, "And ");
#line hidden
#line 121
...
#line 137
    await testRunner.AndAsync("I enter following:", ((string)(null)), table172, "And ");
#line hidden
#line 140
...
#line hidden
        ...
        [NUnit.Framework.TestAttribute()]
        [NUnit.Framework.DescriptionAttribute("05) Rejecting an EM Work Order")]
        [NUnit.Framework.TestCaseAttribute("teamlead", null)]
        public async global::System.Threading.Tasks.Task _05RejectingAnEMWorkOrder(string role, string[] exampleTags)
        {
            string[] tagsOfScenario = exampleTags;
            global::System.Collections.Specialized.OrderedDictionary argumentsOfScenario = new global::System.Collections.Specialized.OrderedDictionary();
            argumentsOfScenario.Add("role", role);
            global::Reqnroll.ScenarioInfo scenarioInfo = new global::Reqnroll.ScenarioInfo("05) Rejecting an EM Work Order", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 153
this.ScenarioInitialize(scenarioInfo);
#line hidden
            if ((global::Reqnroll.TagHelper.ContainsIgnoreTag(scenarioInfo.CombinedTags) || global::Reqnroll.TagHelper.ContainsIgnoreTag(featureTags)))
...
#line hidden
                ...
                table173.AddRow(new string[] {
                            ...
                            "=EM"});
#line 156
    await testRunner.WhenAsync("I filter table EM:", ((string)(null)), table173, "When ");
#line hidden
#line 159
    await testRunner.AndAsync("I select no. 1 record from EM table", ((string)(null)), ((global::Reqnroll.Table)(null)), "And ");
#line hidden
...
#line hidden
#line 161
 await testRunner.AndAsync("I set (Radio) Box to Reject this Work Order", ((string)(null)), ((global::Reqnroll.Table)(null)), "And ");
#line hidden
#line 162
