...
namespace GTR_AUTOMATED.Features.MaintenaceProduction.CM
{
    ...
    [NUnit.Framework.DescriptionAttribute("2.0.5 - Rejecting an CM Work Order")]
    ...
    public partial class _2_0_5_RejectingAnCMWorkOrderFeature
    {
        ...
        private static global::Reqnroll.FeatureInfo featureInfo = new global::Reqnroll.FeatureInfo(new global::System.Globalization.CultureInfo("en-US"), "Features/Maintenace & Production/CM", "2.0.5 - Rejecting an CM Work Order", "You are reviewing Completed Work in your start centre and want to reject it", global::Reqnroll.ProgrammingLanguage.CSharp, featureTags);
...
#line hidden
        ...
        [NUnit.Framework.CategoryAttribute("Feature:2.0.5-RejectinganCMWorkOrder")]
...
#line hidden
#line 10
 await testRunner.AndAsync("I set CM Work Order Description field to \'AUTOT REJECTING CM WO\'", ((string)(null)), ((global::Reqnroll.Table)(null)), "And ");
#line hidden
#line 11
...
#line hidden
                ...
                table98.AddRow(new string[] {
                            "387102"});
#line 12
 await testRunner.AndAsync("I filter table Location:", ((string)(null)), table98, "And ");
#line hidden
#line 15
...
#line hidden
                ...
                table99.AddRow(new string[] {
                            "=CM"});
#line 17
 await testRunner.AndAsync("I filter table Work Type:", ((string)(null)), table99, "And ");
#line hidden
#line 20
...
#line hidden
                ...
                table100.AddRow(new string[] {
                            "HORNSEY"});
#line 22
 await testRunner.AndAsync("I filter table Repair Facility:", ((string)(null)), table100, "And ");
#line hidden
#line 25
...
#line hidden
                ...
                table101.AddRow(new string[] {
                            "Next Exam"});
#line 27
 await testRunner.AndAsync("I filter table Priority field:", ((string)(null)), table101, "And ");
#line hidden
#line 30
...
#line hidden
                ...
                table102.AddRow(new string[] {
                            ...
                            "=WAIT-REV"});
#line 45
  await testRunner.AndAsync("I filter table CM Work Order:", ((string)(null)), table102, "And ");
#line hidden
#line 48
...
#line hidden
                ...
                table103.AddRow(new string[] {
                            "ISCOTT"});
#line 58
  await testRunner.AndAsync("I filter table Labor:", ((string)(null)), table103, "And ");
#line hidden
#line 61
...
#line hidden
                ...
                table104.AddRow(new string[] {
                            ...
                            "=CM"});
#line 78
 await testRunner.AndAsync("I filter table CM:", ((string)(null)), table104, "And ");
#line hidden
#line 81
 await testRunner.AndAsync("I select no. 1 record from CM Work Order table records", ((string)(null)), ((global::Reqnroll.Table)(null)), "And ");
#line hidden
...
#line hidden
                ...
                table105.AddRow(new string[] {
                            "ISCOTT"});
#line 92
 await testRunner.AndAsync("I filter table actuals labor:", ((string)(null)), table105, "And ");
#line hidden
#line 95
...
#line hidden
                ...
                table106.AddRow(new string[] {
                            "171-FC-02"});
#line 102
 await testRunner.AndAsync("I filter table Failure Codes:", ((string)(null)), table106, "And ");
#line hidden
#line 105
...
#line 108
 await testRunner.AndAsync("I enter following data:", ((string)(null)), table107, "And ");
#line hidden
#line 111
    await testRunner.ThenAsync("the record is saved successfully", ((string)(null)), ((global::Reqnroll.Table)(null)), "Then ");
#line hidden
...
#line hidden
        ...
        [NUnit.Framework.TestAttribute()]
        [NUnit.Framework.DescriptionAttribute("04) Rejecting an CM Work Order")]
        [NUnit.Framework.TestCaseAttribute("maintainer teamlead", null)]
        public async global::System.Threading.Tasks.Task _04RejectingAnCMWorkOrder(string role, string[] exampleTags)
        {
            string[] tagsOfScenario = exampleTags;
            global::System.Collections.Specialized.OrderedDictionary argumentsOfScenario = new global::System.Collections.Specialized.OrderedDictionary();
            argumentsOfScenario.Add("role", role);
            global::Reqnroll.ScenarioInfo scenarioInfo = new global::Reqnroll.ScenarioInfo("04) Rejecting an CM Work Order", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 125
this.ScenarioInitialize(scenarioInfo);
#line hidden
            if ((global::Reqnroll.TagHelper.ContainsIgnoreTag(scenarioInfo.CombinedTags) || global::Reqnroll.TagHelper.ContainsIgnoreTag(featureTags)))
...
#line hidden
                ...
                table108.AddRow(new string[] {
                            ...
                            "=CM"});
#line 128
 await testRunner.AndAsync("I filter table CM:", ((string)(null)), table108, "And ");
#line hidden
#line 131
    await testRunner.AndAsync("I select no. 1 record from CM Work Order table records", ((string)(null)), ((global::Reqnroll.Table)(null)), "And ");
#line hidden
