...
#line 10
  await testRunner.AndAsync("I enter following Purchase Requisition:", ((string)(null)), table245, "And ");
#line hidden
#line 13
...
#line 15
 await testRunner.AndAsync("I filter table Company Field:", ((string)(null)), table246, "And ");
#line hidden
#line 18
...
#line hidden
                ...
                table247.AddRow(new string[] {
                            "039/140100"});
#line 23
  await testRunner.AndAsync("I filter table Vendor Items:", ((string)(null)), table247, "And ");
#line hidden
#line 26
...
#line hidden
                ...
                table248.AddRow(new string[] {
                            "HE-VALUE"});
#line 29
 await testRunner.AndAsync("I filter table Storeroom:", ((string)(null)), table248, "And ");
#line hidden
#line 32
...
#line hidden
                ...
                table249.AddRow(new string[] {
                            "00000-00000-0000"});
#line 33
 await testRunner.AndAsync("I enter GL Debit Account:", ((string)(null)), table249, "And ");
#line hidden
#line 36
...
#line hidden
                ...
                table250.AddRow(new string[] {
                            "100"});
#line 37
 await testRunner.AndAsync("I enter  Conversion Factor:", ((string)(null)), table250, "And ");
#line hidden
#line 40
...
#line hidden
                ...
                table251.AddRow(new string[] {
                            "HE-VALUE"});
#line 41
 await testRunner.AndAsync("I filter table Storeroom:", ((string)(null)), table251, "And ");
#line hidden
#line 44
 await testRunner.AndAsync("I select no. 1 record from Storeroom table records", ((string)(null)), ((global::Reqnroll.Table)(null)), "And ");
#line hidden
...
#line hidden
                ...
                table252.AddRow(new string[] {
                            "Approving a PR - Stocked Item Test"});
#line 67
  await testRunner.AndAsync("I filter Portlet table Purchase Requisition:", ((string)(null)), table252, "And ");
#line hidden
#line 70
...
#line 76
 await testRunner.AndAsync("I enter following Item data:", ((string)(null)), table253, "And ");
#line hidden
#line 79
 await testRunner.AndAsync("I save record", ((string)(null)), ((global::Reqnroll.Table)(null)), "And ");
#line hidden
...
#line hidden
                ...
                table254.AddRow(new string[] {
                            ...
                            "APPR"});
#line 85
 await testRunner.AndAsync("I filter table Purchase Orders (Tr):", ((string)(null)), table254, "And ");
#line hidden
#line 88
...
#line hidden
                ...
                table255.AddRow(new string[] {
                            ...
                            "Approving a PR - Stocked Item Auto Test"});
#line 98
 await testRunner.AndAsync("I enter following Work Log data:", ((string)(null)), table255, "And ");
#line hidden
#line 101
 await testRunner.AndAsync("I save record", ((string)(null)), ((global::Reqnroll.Table)(null)), "And ");
#line hidden
