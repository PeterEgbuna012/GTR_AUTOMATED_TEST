...
#line 10
    await testRunner.AndAsync("I enter asset description:", ((string)(null)), table302, "And ");
#line hidden
#line 13
...
#line hidden
                ...
                table303.AddRow(new string[] {
                            "SL-Z-VALUE"});
#line 14
     await testRunner.AndAsync("I filter table Storeroom:", ((string)(null)), table303, "And ");
#line hidden
#line 17
...
#line hidden
                ...
                table304.AddRow(new string[] {
                            "007/042021"});
#line 22
    await testRunner.AndAsync("I filter table Item:", ((string)(null)), table304, "And ");
#line hidden
#line 25
...
#line hidden
                ...
                table305.AddRow(new string[] {
                            "BI-Z-VALUE"});
#line 27
    await testRunner.AndAsync("I filter Storeroom:", ((string)(null)), table305, "And ");
#line hidden
#line 30
...
#line hidden
                ...
                table306.AddRow(new string[] {
                            "GTR-BI"});
#line 36
     await testRunner.AndAsync("I filter Ship To:", ((string)(null)), table306, "And ");
#line hidden
#line 39
...
#line 42
    await testRunner.AndAsync("I filter table Shipment Reports:", ((string)(null)), table307, "And ");
#line hidden
#line 45
