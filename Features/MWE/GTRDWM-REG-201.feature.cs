...
namespace GTR_AUTOMATED.Features.MWE
{
    ...
    public partial class _2_0_1_AssigningACMWorkOrderFeature
    {
        ...
        private static global::Reqnroll.FeatureInfo featureInfo = new global::Reqnroll.FeatureInfo(new global::System.Globalization.CultureInfo("en-US"), "Features/MWE", "2.0.1 - Assigning a CM Work Order", "AS a Team Leader you need to Assign A single CM Work Order where there is no plan" +
...
#line hidden
                ...
                table486.AddRow(new string[] {
                            "MWE TEST"});
#line 10
 await testRunner.AndAsync("I enter work order:", ((string)(null)), table486, "And ");
#line hidden
#line 13
...
#line hidden
                ...
                table487.AddRow(new string[] {
                            "387102"});
#line 14
 await testRunner.AndAsync("I filter table Location:", ((string)(null)), table487, "And ");
#line hidden
#line 17
...
#line hidden
                ...
                table488.AddRow(new string[] {
                            "=CM"});
#line 19
 await testRunner.AndAsync("I filter table Work Type:", ((string)(null)), table488, "And ");
#line hidden
#line 22
...
#line hidden
                ...
                table489.AddRow(new string[] {
                            "HORNSEY"});
#line 24
 await testRunner.AndAsync("I filter table Repair Facility:", ((string)(null)), table489, "And ");
#line hidden
#line 27
...
#line hidden
                ...
                table490.AddRow(new string[] {
                            "Next Exam"});
#line 29
 await testRunner.AndAsync("I filter table Priority field:", ((string)(null)), table490, "And ");
#line hidden
#line 32
...
#line hidden
                ...
                table491.AddRow(new string[] {
                            ...
                            "=WAIT-REV"});
#line 47
  await testRunner.AndAsync("I filter table CM Work Order:", ((string)(null)), table491, "And ");
#line hidden
#line 50
...
#line hidden
                ...
                table492.AddRow(new string[] {
                            "Comment"});
#line 59
  await testRunner.AndAsync("I enter CM Task Description:", ((string)(null)), table492, "And ");
#line hidden
#line 62
...
#line hidden
                ...
                table493.AddRow(new string[] {
                            "Meters"});
#line 65
  await testRunner.AndAsync("I enter CM Task Description:", ((string)(null)), table493, "And ");
#line hidden
#line 69
...
#line hidden
                ...
                table494.AddRow(new string[] {
                            "P000031"});
#line 70
  await testRunner.AndAsync("I filter table Measurement Point:", ((string)(null)), table494, "And ");
#line hidden
#line 73
...
#line hidden
                ...
                table495.AddRow(new string[] {
                            "CBRUNS"});
#line 78
  await testRunner.AndAsync("I filter table Labor:", ((string)(null)), table495, "And ");
#line hidden
#line 81
