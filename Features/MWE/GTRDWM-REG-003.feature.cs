...
namespace GTR_AUTOMATED.Features.MWE
{
    ...
    public partial class _0_0_3_AssigningAnEMWorkOrderFeature
    {
        ...
        private static global::Reqnroll.FeatureInfo featureInfo = new global::Reqnroll.FeatureInfo(new global::System.Globalization.CultureInfo("en-US"), "Features/MWE", "0.0.3 - Assigning an EM Work Order", "An EM work order is scheduled and ready to be assigned to the person who will com" +
...
#line hidden
                ...
                table476.AddRow(new string[] {
                            "HORNSEY"});
#line 12
    await testRunner.AndAsync("I filter table Location:", ((string)(null)), table476, "And ");
#line hidden
#line 15
...
#line hidden
                ...
                table477.AddRow(new string[] {
                            "HORNSEY"});
#line 23
    await testRunner.AndAsync("I filter table Repair Facility:", ((string)(null)), table477, "And ");
#line hidden
#line 26
...
#line hidden
                ...
                table478.AddRow(new string[] {
                            "TAUTO"});
#line 29
    await testRunner.AndAsync("I enter following data to Headcode:", ((string)(null)), table478, "And ");
#line hidden
...
#line 32
    await testRunner.AndAsync("I enter following data:", ((string)(null)), table479, "And ");
#line hidden
#line 35
...
#line hidden
                ...
                table480.AddRow(new string[] {
                            ...
                            "=EM"});
#line 57
     await testRunner.WhenAsync("I filter table EM:", ((string)(null)), table480, "When ");
#line hidden
#line 60
...
#line hidden
                ...
                table481.AddRow(new string[] {
                            ...
                            "=EM"});
#line 78
      await testRunner.WhenAsync("I filter table EM:", ((string)(null)), table481, "When ");
#line hidden
#line 81
     await testRunner.AndAsync("I select no. 1 record from EM table", ((string)(null)), ((global::Reqnroll.Table)(null)), "And ");
#line hidden
...
#line hidden
                ...
                table482.AddRow(new string[] {
                            "Comment"});
#line 84
     await testRunner.AndAsync("I enter Task Description:", ((string)(null)), table482, "And ");
#line hidden
#line 87
...
#line hidden
                ...
                table483.AddRow(new string[] {
                            "Meters"});
#line 90
     await testRunner.AndAsync("I enter Task Description:", ((string)(null)), table483, "And ");
#line hidden
#line 94
...
#line hidden
                ...
                table484.AddRow(new string[] {
                            "P000031"});
#line 95
    await testRunner.AndAsync("I filter table Measurement Point:", ((string)(null)), table484, "And ");
#line hidden
#line 98
...
#line hidden
                ...
                table485.AddRow(new string[] {
                            "CBRUNS"});
#line 103
     await testRunner.AndAsync("I filter table labor:", ((string)(null)), table485, "And ");
#line hidden
#line 106
