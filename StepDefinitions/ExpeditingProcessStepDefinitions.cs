...
namespace GTR_AUTOMATED.StepDefinitions
{
    ...
    public sealed class ExpeditingProcessStepDefinitions
    {
        ...
        public void GivenISignAsMaterialsController()
        {
            var loginPage = new LoginPage(driver);
            loginPage.LoginAsMaterialsController();
            AllureLogger.SetUserLoginRole("materials controller");
        }

        [Given("I sign as materials depot manager")]
        public void GivenISignAsMaterialsDepotManager()
        {
            var loginPage = new LoginPage(driver);
            loginPage.LoginAsMaterialsDepotManager();
            AllureLogger.SetUserLoginRole("Depot Manager");
        }
